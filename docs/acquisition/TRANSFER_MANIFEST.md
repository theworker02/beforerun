# Transfer manifest â€” Scan the current directory

## Schedule A â€” Included (typical)

1. Git repository `theworker02/beforerun` (or content transfer)
2. Original Product source/docs as of closing tag
3. `docs/acquisition/` diligence materials
4. In-repo marks created for Scan the current directory
