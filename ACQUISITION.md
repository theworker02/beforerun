# Acquisition Brief â€” Scan the current directory

**Date:** 2026-09-22  
**Repository:** https://github.com/theworker02/beforerun  
**Default branch:** `main`  
**Primary language:** Go  
...
<img src="assets/brand/beforerun-lockup.svg" alt="BeforeRun Ã¢â‚¬â€ inspect before execution" width="760"> <strong>Zero-dependency security intake scanner for untrusted repositories.</strong> <a href="https://github.com/theworker02/beforerun/actions/workflows/ci.yml"><img alt="CI" src="https://github.com/theworker02/beforerun/actions/workflows/ci.yml/badge.svg"></a>

**Why a buyer cares:** Scan the current directory packages transferable product IP â€” source, docs, in-repo brand assets, and a diligence room under `docs/acquisition/` â€” under a clear proprietary posture so diligence can proceed without mistaking the repo for open source.
...
| Item | Detail |
|------|--------|
| Product | Scan the current directory |
| Repo | `theworker02/beforerun` |
| Language | Go |
...
Teams evaluating Scan the current directory typically need either (a) a commercial right to run or embed it, or (b) outright ownership of the Product IP for strategic build-out. Public GitHub visibility without a proprietary license creates false assumptions about free production use. This brief and the linked data room make the commercial path explicit.
